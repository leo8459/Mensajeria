...
class Ventanilla72 extends Component
{
     use WithFileUploads;
    ...
    /* ─────────── cuenta ─────────── */
    public string $acc = 'ventanilla72';                     // wa1 | wa2 | wa3
    ...
    /* ─────────── ciclo de vida ─────────── */
    public function mount(string $acc = 'ventanilla72')
    {
        $this->acc = $acc;
        $this->actualizarQR();
        $this->cargarMensajes();
    ...
    {
        return view('livewire.ventanilla72');
    }
}
