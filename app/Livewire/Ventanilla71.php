...
class Ventanilla71 extends Component
{
     use WithFileUploads;
    ...
    /* ─────────── cuenta ─────────── */
    public string $acc = 'ventanilla71';                     // wa1 | wa2 | wa3
    ...
    /* ─────────── ciclo de vida ─────────── */
    public function mount(string $acc = 'ventanilla71')
    {
        $this->acc = $acc;
        $this->actualizarQR();
        $this->cargarMensajes();
    ...
    {
        return view('livewire.ventanilla71');
    }
}
