...
<div>
    ...
    <div class="container my-3 d-flex flex-wrap gap-2 justify-content-end">
        <input wire:model.defer="scan" wire:keydown.enter.prevent="agregarAPrelista" class="form-control w-auto"
    ...
    <div class="tab-content">
        ...
        @if ($uiTab === 'todos')
            <div class="container">
                ...
                <div class="text-center py-4">
                    ...
                    <button class="btn btn-primary btn-lg" wire:click="enviarTodos" wire:loading.attr="disabled"
                        @disabled(!$packages)>
        ...
        @if ($uiTab === 'prelista')
            <div class="container">
                ...
                <button class="btn btn-warning w-100 mb-4" wire:click="mandarPrelista" wire:loading.attr="disabled"
        ...
        @if ($uiTab === 'excel')
            <div class="container" style="max-width:450px">
                ...
                <button class="btn btn-success w-100 mt-3" wire:click="enviarExcel" wire:loading.attr="disabled"
                    @disabled(!$archivoExcel)>
                    <i class="bi bi-send-check me-1"></i>Enviar Mensajes
                </button>

                <div wire:loading wire:target="enviarExcel" class="small text-secondary mt-2">
